...
treatment is a decision to make once and keep fixed; (3) SR says nothing about skew —
motivating everything in M5/M6. Pinned here: rf = collateral T-bill on fully-collateralized
...
negative, negative stock/bond correlations, and — the decomposition that matters — futures
payoff = risk premium + unexpected spot deviation: expected spot declines never enter the
